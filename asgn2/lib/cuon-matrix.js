...
class Vector3 {
    ...
    magnitude() {
        // Insert your code here.
        let a = this.elements[0] * this.elements[0];
        let b = this.elements[1] * this.elements[1];
        let c = this.elements[2] * this.elements[2];
    ...
    normalize() {
        ...
        // Don't delete the return statement.
        this.elements[0]/=mag1;
        this.elements[1]/=mag1;
        this.elements[2]/=mag1;
        return this;
    };
}
